	...
	<tbody>
		<tr>
			...
			<td>
				...
				<input type="hidden" name="createUser.id" value="${device.createUser.id}">
			</td>
			<th>类型</th>
			<td>
				<input type="text" value="${device.deviceType.name}" readonly="readonly">
				<input type="hidden" name="device.deviceType.id" value="${device.deviceType.id}">
			</td>
		</tr>
		<tr>
			<th>名称</th>
			<td>
				<input type="text" name="name" value="${device.name}" readonly="readonly"/>
			</td>
			<th>单价	</th>
			<td>
				<input type="text" name="price" value="${device.price}" onkeyup="javascript:check(this);" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<th>排序</th>
			<td>
				<input type="text" name="sort" value="${device.sort}" readonly="readonly"/>
			</td>
			<td colspan="2"></td>
		</tr>
		<tr>
			<th>备注</th>
			<td colspan="3">
				<textarea name="remark" readonly="readonly">${device.remark}</textarea>
			</td>
		</tr>
