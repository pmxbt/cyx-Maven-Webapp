...
<table>
	<tbody class="mb">
		<tr>
			<td>
				<div id="find">
					<lable>日期</lable>
					<input class="Wdate" type="text" name="startTime" value="${startTime}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
					--<input class="Wdate" type="text" name="endTime" value="${endTime}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
					<lable>部门</lable>
					<select name="dept_id">
						<option></option>
					 ...
					 <button   type="button" id="getbtn">查 询</button>
				...
				<table cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
					...
					<tbody>
						...
						<tr>
							...
							<td><button onclick="dc(${d.id})">导出</button></td>
							<td>
  ...
  <script type="text/javascript">
  	...
  	function dc(id){
  		$("#form").attr("action","/cyx/dealTrouble/dc?id="+id);
		$("#form").submit(); 
  	}
  </script>
</html>